...
StartScreen::StartScreen() {
	...
	m_pCursor = new AnimatedTexture("Paddle.png", 95, 0, 360, 180, 4, 0.5f, AnimatedTexture::Vertical);
	...
	m_pPlayModes->Position(Graphics::SCREEN_WIDTH * 0.5f, -120.0f);
